...
const TrendingJobIcon = (props: TrendingJobIconProps): JSX.Element => {
    ...
    switch (props.companyName) {
        ...
        case TRENDING_JOBS.SUPPLY_CHAIN:
            return (
                <svg
                    aria-hidden="true"
                    className={styleClass}
        ...
        case TRENDING_JOBS.DATA_SCIENCE:
            return (
                <svg
                    aria-hidden="true"
                    className={styleClass}
...
export default TrendingJobIcon;
